...
const TransactionSidebar: React.FC<TransactionSidebarProps> = ({
    ...
    return (
        <div className="fixed left-0 top-0 h-full w-1/3 min-w-108 bg-gray-800 shadow-xl z-50 transform transition-transform duration-300 ease-in-out overflow-y-auto">
